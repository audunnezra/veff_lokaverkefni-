...
var mid = {color:'white', "height":'200rem'}
var container = {"height":"100wh"}

var hgb = {"height":'200rem', backgroundColor:'#3cfadb', textAlign:'center'}
var gbh = {"height":'200rem', backgroundColor:'indigo', textAlign:'center'}
var bgh = {"height":'200rem', backgroundColor:'#007fad', textAlign:'center'}
      ...
      <div id="homepage" style={container}>
        ...
        <Col xs={12} sm={12} md={10} lg={8} style={mid}>
            <Col xs={4} sm={4} md={2.5} lg={2.66666667} style={hgb}>
              <div style={sizer}>haha</div>
              <div style={sizer}>gei</div>
              <div style={sizer}>bwa</div>
              <div style={sizer}>bwa</div>
              <div style={sizer}>bwa</div>
              <div style={sizer}>bwa</div>
            </Col>
